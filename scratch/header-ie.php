...
<div class="helpbarcontainer">
	<div class="helpbar">
		...
		<div class="home"><a href="<?php echo get_home_url(); ?>"><img src="<?php bloginfo('template_url'); ?>/assets/img/home.png" alt="Home" /></a></div>
				<div class="dropdown">
					<div class="toc"><a href="<?php echo get_home_url(); ?>"><img src="<?php bloginfo('template_url'); ?>/assets/img/toc.png" alt="Table of Contents" style="float:left;" /></a><h3><span class="highlight">Fall 2011</span> <span class="articlename"><?php wp_title(); ?></span></h3></div>
