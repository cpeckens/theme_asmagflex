...
<div id="nav_area">   <!-- <div id="nav_area" onclick="AppearEffect(this);"> -->        
    	        <div id="navcover">          
                    <div id="nav_tab">  <!-- <div id="nav_tab" onclick="SUDEffect('nav_area')"> -->
                     ...
                     <li><a href="#intern2"><img src="<?php bloginfo('template_url'); ?>/assets/img/fall11/btn-2.png" alt="Frank"></a></li>
                     <li><a href="#intern3"><img src="<?php bloginfo('template_url'); ?>/assets/img/fall11/btn-3.png" alt="Joanna"></a></li>
                     <li><a href="#intern4"><img src="<?php bloginfo('template_url'); ?>/assets/img/fall11/btn-4.png" alt="Dominique"></a></li>
                     </ul>
	            </div>  
            </div>